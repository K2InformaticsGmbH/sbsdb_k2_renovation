...
rem ----------------------------------------------------------------------------
rem
rem run_install_full_docker.bat: SBSDB - full installation of the database software.
rem
rem ----------------------------------------------------------------------------
...
echo.
echo You can find the run log in the file run_install_full_docker.log
echo.
echo Please wait ...
echo.

> run_install_full_docker.log (
