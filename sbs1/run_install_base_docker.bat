...
rem ----------------------------------------------------------------------------
rem
rem run_install_base_docker.bat: SBSDB - basic SBSDB installation of the database software.
rem
rem ----------------------------------------------------------------------------
...
echo.
echo You can find the run log in the file run_install_base_docker.log
echo.
echo Please wait ...
echo.

> run_install_base_docker.log (

    echo =======================================================================
    echo Start %0
    echo -----------------------------------------------------------------------
    echo Installing basic SBSDB Schema
    echo -----------------------------------------------------------------------
    ...
    (
        ...
        echo @install/sbsdb_schema_update_software_sbsdb.sql %USERNAME_SBSDB% %PASSWORD_SBSDB% %CONNECT_IDENTIFIER%
